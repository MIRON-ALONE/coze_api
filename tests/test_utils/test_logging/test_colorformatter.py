...
import click
import logging
from coze_api.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("coze_api.app.utils.logging.click.style",
    ...
    @mock.patch("coze_api.app.utils.logging.logging.Formatter")
